...
//   return (
//     <div className="bg-zinc-800 text-white p-4 rounded-lg shadow-md mt-4 createpollo">
//       <button
//                 onClick={() => {
//                   setShowPoll(false);
//                   if (cross) cross();
...
//                 </svg>
//               </button>
//       <h3 className="font-bold text-lg mb-2 createpollotitle">{data.question}</h3>
//       <ul className="list-disc pl-5 text-gray-300 createpolloptions">
