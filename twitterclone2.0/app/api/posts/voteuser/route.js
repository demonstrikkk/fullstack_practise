// // server/app/api/posts/vote/route.js
...
//     if (post.content.poll.votedUsers.includes(userEmail)) {
...
//     const option = post.content.poll.options.find(o => o.text === selectedOption);
//     if (!option) {
//       return NextResponse.json({ error: "Option not found" }, { status: 400 });
//     }

//     option.votes += 1;
//     post.content.poll.votedUsers.push(userEmail);
//     await post.save();
